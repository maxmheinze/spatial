...
First of all, it should be noted that the bonus question largely refers to the paper by \textcite{kuschnig2022}. Thereby, parts of it are replicated in this exercise to answer the question asked in the task assignment. In order to have the same initial data, the first step is therefore to reload the data used in this exercise in a way that is identical to the specifications used in the paper. 
...
```{r Bonus question code, echo=TRUE, results='hide'}
