...
knitr::kable(summary(model_3)$CoefTable[1:14,], caption = "Replication of Column 3.", format = "simple")
```

```{r print_col_4, echo = FALSE}
knitr::kable(summary(model_4)$CoefTable[1:14,], caption = "Replication of Column 4.", format = "simple")
```
